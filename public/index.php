        ...
        <div class="hidden lg:flex lg:flex-1 lg:justify-end">
            <?php
                if (isset($_SESSION['user_id'])) {
                    echo '<a href="dashboard.php" class="text-sm font-semibold leading-6 text-gray-900">Dashboard<span aria-hidden="true"></a>';
                }else{
                    echo '<a href="register.php" class="text-sm font-semibold leading-6 text-gray-900">Register<span aria-hidden="true"></a> <a href="login.php" class="ms-5 text-sm font-semibold leading-6 text-gray-900">Log in <span aria-hidden="true">&rarr;</span></a>';
                }
